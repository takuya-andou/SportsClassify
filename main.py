...
def classify():
    ...
    bask = round(result[0]["score"][0]*100,1)
    soccer = round(result[0]["score"][1]*100,1)
    tennis = round(result[0]["score"][2]*100,1)
    volleyball = round(result[0]["score"][3]*100,1)

    return render_template('result.html',bask=bask,soccer=soccer,tennis=tennis,volleyball=volleyball)
